...
<script type="text/javascript">
   function formfocus() {
      document.getElementById('concept4keyword1').focus();
   }
...
<h4>Now your final key concept, <em><?php echo $new_concept_text; ?></em>:</h4>

<p><label for="concept4keyword1" class="hidden">Keyword 1</label><input id="concept4keyword1" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept4keyword2" class="hidden">Keyword 2</label><input id="concept4keyword2" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept4keyword3" class="hidden">Keyword 3</label><input id="concept4keyword3" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept4keyword4" class="hidden">Keyword 4</label><input id="concept4keyword4" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept4keyword5" class="hidden">Keyword 5</label><input id="concept4keyword5" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept4keyword6" class="hidden">Keyword 6</label><input id="concept4keyword6" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept4keyword7" class="hidden">Keyword 7</label><input id="concept4keyword7" type="text" name="keyword[]" class="dataentry"></p>
