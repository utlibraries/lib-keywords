...
<script type="text/javascript">
   function formfocus() {
      document.getElementById('concept2keyword1').focus();
   }
...
if ( isset($all_concepts[2]) && ($all_concepts[2] != "") ) {
    print "<form action=\"keywords3.php\" method=\"POST\">\n" ;
} else {
...
<h4>Now your second key concept, <em><?php echo $new_concept_text; ?></em>:</h4>


<p><label for="concept2keyword1" class="hidden">Keyword 1</label><input id="concept2keyword1" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept2keyword2" class="hidden">Keyword 2</label><input id="concept2keyword2" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept2keyword3" class="hidden">Keyword 3</label><input id="concept2keyword3" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept2keyword4" class="hidden">Keyword 4</label><input id="concept2keyword4" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept2keyword5" class="hidden">Keyword 5</label><input id="concept2keyword5" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept2keyword6" class="hidden">Keyword 6</label><input id="concept2keyword6" type="text" name="keyword[]" class="dataentry"></p>
<p><label for="concept2keyword7" class="hidden">Keyword 7</label><input id="concept2keyword7" type="text" name="keyword[]" class="dataentry"></p>
